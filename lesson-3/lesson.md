...
- With direction adapt last lessons code to poll the rain gauge and count signals.

### Most students are able to

- Explain how we convert bucket tips into a useful measurement.
- With direction adapt last lessons code to use interrupts to count signals

### Some students are able to

- Independantly adapt their code to count the number of bucket tips and display meaningful rainfall data.
